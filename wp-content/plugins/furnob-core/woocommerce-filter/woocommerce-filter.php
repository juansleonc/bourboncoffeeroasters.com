...
/* Free Shipping */
if(get_theme_mod('furnob_free_shipping',0) == 1){
...
*************************************************/
function furnob_hide_shipping_when_free_is_available( $rates, $package ) {
	$new_rates = array();
...
add_filter( 'woocommerce_package_rates', 'furnob_hide_shipping_when_free_is_available', 10, 2 );