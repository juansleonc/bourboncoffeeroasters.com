...
class Furnob_Banner_Box3_Widget extends Widget_Base {

    public function get_name() {
        return 'furnob-banner-box3';
    }
	...
	protected function register_controls() {
        ...
        $this->add_control( 'title',
            [
                ...
                'default' => 'Introducing the Totem Collection',
        ...
        $this->add_control( 'desc',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => 'Maecenas at purus facilisis, sagittis tellus at, sagittis massa.',
                'description'=> 'Add a subtitle.',
				'label_block' => true,
            ]
        );
	...
	protected function render() {
		...
		echo '<div class="banner dark overlay small">';
