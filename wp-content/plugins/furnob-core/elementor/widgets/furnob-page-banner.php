...
class Furnob_Page_Banner_Widget extends Widget_Base {

    public function get_name() {
        return 'furnob-page-banner';
    }
	...
	protected function register_controls() {
		...
		$defaultimage = plugins_url( 'images/page-banner.jpg', __DIR__ );
        ...
        $this->add_control( 'subtitle',
            [
                ...
                'default' => 'About Us Furnob Furniture',
        ...
        $this->add_control( 'desc',
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'default' => 'Let us introduce the furnob to you briefly, so you will have a better understanding of our quality',
		...
		$this->add_responsive_control( 'home_slider_alignment',
            [
                ...
                'selectors' => ['{{WRAPPER}} .page-header .container' => 'text-align: {{VALUE}};'],
                'options' => [
                    'left' => [
	...
	protected function render() {
		...
		echo '<div class="page-header overlay" style="background-image: url('.esc_url($settings['image']['url']).');">';
