...
class Furnob_Subscribe_Box_Widget extends Widget_Base {

    public function get_name() {
        return 'furnob-subscribe-box';
    }
	...
	protected function register_controls() {
		...
		$defaultimage = plugins_url( 'images/subscribe-box.jpg', __DIR__ );
		...
		$this->add_control( 'form_heading',
            [
                'label' => esc_html__( 'FORM', 'furnob-core' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
            ]
        );
		...
		$this->add_control( 'form_color',
			[
               'label' => esc_html__( 'Form Color', 'furnob-core' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
               'selectors' => ['{{WRAPPER}} .banner.newsletter .newsletter-form , {{WRAPPER}} .banner.newsletter .newsletter-form .subsribe-form .subscribe-input' => 'color: {{VALUE}};']
			]
        );
	...
	protected function render() {
		...
		echo '<div class="banner light overlay newsletter">';
		...
		echo '<div class="subsribe-form">';
		echo do_shortcode('[mc4wp_form id="'.get_theme_mod('furnob_footer_subscribe_formid').'"]');
		echo '</div><!-- subscribe-form -->';
		echo '</div><!-- newsletter-form -->';
