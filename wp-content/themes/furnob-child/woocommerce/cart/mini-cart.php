					...
					<div class="product-content">
						...
						<div class="content-wrapper">
							...
							echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
								...
								sprintf(
									'<a role="button" href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s" data-success_message="%s"><i class="klbth-icon-x"></i></a>',
...
<?php else : ?>
	...
	<div class="empty-mini-cart">
		...
		<div class="entry-desc"><?php esc_html_e( 'No products in the cart.', 'woocommerce' ); ?></div>
		<a href="<?php echo wc_get_page_permalink( 'shop' ); ?>" class="btn btn-primary"><?php esc_html_e( 'Return To Shop', 'woocommerce' ); ?></a>
	</div><!-- empty-mini-cart -->
